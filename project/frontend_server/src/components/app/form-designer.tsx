...
import DesignerSidebar from "./form-designer-siderbar";
...
import PropertiesFormSidebar from "./form-properties-form-sidebar";
...
function DesignerElementWrapper({ element }: { element: FormElementInstance }) {
  ...
  return (
    <div
      ...
      className="relative h-auto min-h-[120px] flex flex-col text-foreground hover:cursor-pointer rounded-md ring-1 ring-accent ring-inset"
      onMouseEnter={() => {
        setMouseIsOver(true);
      }}
      onMouseLeave={() => {
